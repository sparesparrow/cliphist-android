...
class ClipboardUseCasesTest {
    ...
    @Test
    fun `AddClipboardItemUseCase adds new item when content is unique`() = runTest {
        // Given
    ...
    @Test
    fun `AddClipboardItemUseCase returns null when content already exists`() = runTest {
        // Given
    ...
    @Test
    fun `AddClipboardItemUseCase respects encryption setting`() = runTest {
        // Given
        val content = "Test content"
    ...
    @Test
    fun `GetAllClipboardItemsUseCase returns all items`() = runTest {
        // Given
        val items = listOf(
    ...
    @Test
    fun `DeleteClipboardItemUseCase deletes item`() = runTest {
        // Given
    ...
    @Test
    fun `UpdateClipboardItemUseCase updates item`() = runTest {
        // Given
    ...
    @Test
    fun `GetClipboardSettingsUseCase returns settings`() = runTest {
        // Given
    ...
    @Test
    fun `UpdateClipboardSettingsUseCase updates settings`() = runTest {
        // Given
    ...
    @Test
    fun `CleanupOldItemsUseCase cleans up old items`() = runTest {
        // Given
    ...
    @Test
    fun `AddClipboardItemUseCase with different content types`() = runTest {
        // Given
    ...
    @Test
    fun `AddClipboardItemUseCase calculates correct size`() = runTest {
        // Given
