...
class ContentAnalyzerTest {
    ...
    fun `analyzeContentType falls back to TEXT for long content`() {
        val result = ContentAnalyzer.analyzeContentType("This is a very long text content that exceeds the maps detection threshold and should be classified as regular text content")
        assertEquals(ContentAnalyzer.Type.TEXT, result)
    }
