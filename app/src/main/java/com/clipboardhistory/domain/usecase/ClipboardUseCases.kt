 ...
 * @property repository The clipboard repository
 */
class GetAllClipboardItemsUseCase
    @Inject
    constructor(
        private val repository: ClipboardRepository,
    ) {
 ...
 * @property repository The clipboard repository
 */
class UpdateClipboardItemUseCase
    @Inject
    constructor(
        private val repository: ClipboardRepository,
    ) {
 ...
 * @property repository The clipboard repository
 */
class GetClipboardSettingsUseCase
    @Inject
    constructor(
        private val repository: ClipboardRepository,
    ) {
 ...
 * @property repository The clipboard repository
 */
class UpdateClipboardSettingsUseCase
    @Inject
    constructor(
        private val repository: ClipboardRepository,
    ) {
